...
public interface WeatherWebServiceSoap {
     ...
     * @return
     *     returns com.weil.webservice.jj.ArrayOfString
     */
    @WebMethod(action = "http://WebXml.com.cn/getSupportCity")
    @WebResult(name = "getSupportCityResult", targetNamespace = "http://WebXml.com.cn/")
    @RequestWrapper(localName = "getSupportCity", targetNamespace = "http://WebXml.com.cn/", className = "com.weil.webservice.jj.GetSupportCity")
    @ResponseWrapper(localName = "getSupportCityResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.weil.webservice.jj.GetSupportCityResponse")
    ...
    @RequestWrapper(localName = "getSupportProvince", targetNamespace = "http://WebXml.com.cn/", className = "com.weil.webservice.jj.GetSupportProvince")
    @ResponseWrapper(localName = "getSupportProvinceResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.weil.webservice.jj.GetSupportProvinceResponse")
     ...
     * 
     * @return
     *     returns com.weil.webservice.jj.GetSupportDataSetResponse.GetSupportDataSetResult
     */
    ...
    @RequestWrapper(localName = "getSupportDataSet", targetNamespace = "http://WebXml.com.cn/", className = "com.weil.webservice.jj.GetSupportDataSet")
    @ResponseWrapper(localName = "getSupportDataSetResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.weil.webservice.jj.GetSupportDataSetResponse")
    public com.weil.webservice.jj.GetSupportDataSetResponse.GetSupportDataSetResult getSupportDataSet();
    ...
    @RequestWrapper(localName = "getWeatherbyCityName", targetNamespace = "http://WebXml.com.cn/", className = "com.weil.webservice.jj.GetWeatherbyCityName")
    @ResponseWrapper(localName = "getWeatherbyCityNameResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.weil.webservice.jj.GetWeatherbyCityNameResponse")
    ...
    @RequestWrapper(localName = "getWeatherbyCityNamePro", targetNamespace = "http://WebXml.com.cn/", className = "com.weil.webservice.jj.GetWeatherbyCityNamePro")
    @ResponseWrapper(localName = "getWeatherbyCityNameProResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.weil.webservice.jj.GetWeatherbyCityNameProResponse")
